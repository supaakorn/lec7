...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference("Score.count") do
      post scores_url, params: { score: { grade: @score.grade, point: @score.point, subject: @score.subject } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { grade: @score.grade, point: @score.point, subject: @score.subject } }
